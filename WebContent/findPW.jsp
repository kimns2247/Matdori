...
<a href="index.jsp"><img class="logo" src="./images/matdori_logo.png" alt="" width="100" height="100"></a>
 ...
 <h4 class="h3 mb-3 fw-normal" id="info1" align="center">
  비밀번호 변경 페이지입니다.</h4><br>
  
  <h5 align="center">비밀번호 변경</h5><br>
 
 
 <form action = "newPW.do" method = "post">
  <main class="form-signin w-100 m-auto text-center">
   ...
   <div class="form-floating" style="display: inline-block; width: 450px;">
   <input type="password" class="form-control" id = "newPW" name = "newPW" style="font-family: auto;"><br>
    <label for="floatingInput"> 변경할 비밀번호 </label>
   </div>
   
 <button type="submit" id="button" class="button">변경하기</button><br><br>
