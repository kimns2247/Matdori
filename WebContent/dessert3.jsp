...
<div class="logo">
 ...
 <div #swiperRef="" class="swiper mySwiper">
    <div class="swiper-wrapper">
        <img src="./dessert/cafe1.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./dessert/cafe2.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./dessert/cafe3.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./dessert/cafe4.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./dessert/cafe5.jpg">
      ...
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
          <div class="card-header py-3">
            <h4 class="my-0 fw-normal" align="left">카페 하운트</h4>
          </div>
          <div class="card-body">
            <h5 class="card-title pricing-card-title" align="left"><small class="text-body-secondary fw-light"></small>
              HAUNT 자주가는장소, 아지트를 나타내는 단어 중 하나 입니다.<br>
	오시는 모든 분들이 편안하고 기분 좋은 공간이<br>
	되었으면 하는 마음으로 준비하겠습니다. <br>
	감사합니다 :)<br>
          </div>
        </div>
      </div>
   ...
   <div class="text-center">  
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
          ...
          <div class="card-body">
            <h5 class="card-title pricing-card-title" align="left"><small class="text-body-secondary fw-light"></small>
               주소:서울 종로구 화중로130번길 5-32 <br>
   영업시간: 11:00 - 22:00<br>
   전화번호: 070-4123-7420 <br>
   주차정보: 주차 불가<br>
          </div>
        </div>
      </div>
    ...
    <div class="text-center">  
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
         ...
         mapOption = { 
             center: new kakao.maps.LatLng(37.5740967, 126.9879906), // 지도의 중심좌표
             level: 3 // 지도의 확대 레벨
         };
         ...
         //마커가 표시될 위치입니다 
         var markerPosition  = new kakao.maps.LatLng(37.5740967, 126.9879906); 
         ...
         var iwContent = '<div style="width:150px;text-align:center;padding:6px 0;">카페하운트', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
         iwPosition = new kakao.maps.LatLng(37.5740967, 126.9879906); //인포윈도우 표시 위치입니다
