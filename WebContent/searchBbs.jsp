...
<body>
   ...
   %>
     ...
     <%
      if(boardID == 1){
     %>      
         <img src = "bbshansik.jpg" style="width:1680px; height:330px;">
...
<%--    
   ...
   <nav class="navbar navbar-default">
      <div class="navbar-header">
         ...
         <a class="navbar-brand" href="mdr_main.jsp">
            <p style="font-weight: bold">맛도리</p>
         </a>
      </div>
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
         <ul class="nav navbar-nav">
            <li><a href="mdr_main.jsp">메인</a></li>
            <% if (boardID == 1){ %>
               <li class="active"><a href="bbs.jsp?boardID=1">맛집 리뷰</a></li>
               <li><a href="bbs.jsp?boardID=2">자유 게시판</a></li>
            <%} else if(boardID == 2){ %>
               <li><a href="bbs.jsp?boardID=1">맛집 리뷰</a></li>
