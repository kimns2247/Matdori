...
<div class="logo">
 ...
 <div #swiperRef="" class="swiper mySwiper">
    <div class="swiper-wrapper">
      ...
      <img src="./dessert/brunch1.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./dessert/brunch2.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./dessert/brunch3.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./dessert/brunch4.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./dessert/brunch5.jpg">
  ...
  <script>
      ...
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
          <div class="card-header py-3">
            <h4 class="my-0 fw-normal" align="left">히포 브런치하우스</h4>
          </div>
          <div class="card-body">
            <h5 class="card-title pricing-card-title" align="left"><small class="text-body-secondary fw-light"></small>
                 
   하마의 거대한 입처럼 푸짐한 음식을 만들자는 취지로 만들어진 공간입니다.<br><br>
	- 모든 소스와 음식은 직접 만들고 제조합니다.<br>
	- 당일 재료 당일 소진 원칙으로 합니다.<br>
	- 국내산 재료를 원칙으로 합니다.<br>
	- 아이와 함께 먹을 수 있도록 인공조미료를 최소화합니다.<br>
          </div>
        </div>
      </div>
    </div> 
   ...
   <div class="text-center">  
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
          ...
          <div class="card-body">
            <h5 class="card-title pricing-card-title" align="left"><small class="text-body-secondary fw-light"></small>
              주소: 서울 마포구 성미산로17길 85 B1<br>
   영업시간: 10:00 - 20:00 <br>
   전화번호: 0507-1320-6219<br>
   주차정보: 주차 불가로 인근 공영주차장 또는 모두의 주차장 어플을 이용해주시기 바랍니다.<br>
          </div>
        </div>
      </div>
   </div>
    ...
    <div class="text-center">  
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
         ...
         mapOption = { 
             center: new kakao.maps.LatLng(37.5744197, 126.9879906), // 지도의 중심좌표
             level: 3 // 지도의 확대 레벨
         };
         ...
         //마커가 표시될 위치입니다 
         var markerPosition  = new kakao.maps.LatLng(37.5744197, 126.9879906); 
         ...
         var iwContent = '<div style="width:150px;text-align:center;padding:6px 0;">히포브런치', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
         iwPosition = new kakao.maps.LatLng(37.5744197, 126.9879906); //인포윈도우 표시 위치입니다
   ...
   <div class="text-center">  
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
          <div class="card-header py-3">
            <h4 class="my-0 fw-normal" align="left">추천리뷰 <h6><a href = "bbs.jsp?boardID=5&pageNumber=1" style="float:right;" >리뷰 전체보기</a></h6></h4>
          </div>
          <div class="card-body">
            <h5 class="card-title pricing-card-title" align="left"><small class="text-body-secondary fw-light"></small>
      ...
      <img src="./dessert/brunch5.jpg">
           ...
           <input type='button' class='btn2' name='btn2' value='리뷰작성' onclick="location.href='write.jsp?boardID=5'" style="float:right; width:200px;">
