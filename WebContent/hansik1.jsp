...
<div class="logo">
 ...
 <div #swiperRef="" class="swiper mySwiper">
    <div class="swiper-wrapper">
      <img src="./hansik/course1.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./hansik/course2.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./hansik/course3.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./hansik/course4.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./hansik/course5.jpg">
      ...
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
          <div class="card-header py-3">
            <h4 class="my-0 fw-normal" align="left">뜻한바</h4>
          </div>
          <div class="card-body">
            <h5 class="card-title pricing-card-title" align="left"><small class="text-body-secondary fw-light"></small>
                 저희 매장은 2인당 주류1병을 필수로 해주셔야 하는 매장입니다. <br>
              온라인 예약은 2명까지만 예약가능하십니다 매장 특성상 3명은<br>
              예약불가하고 4명예약은 매장으로 따로 문의주시고 평일은 가능하나 주말은 어려운점 양해부탁드립니다</h5>
          </div>
        </div>
      </div>
    </div> 
   ...
   <div class="text-center">  
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
          ...
          <div class="card-body">
            <h5 class="card-title pricing-card-title" align="left"><small class="text-body-secondary fw-light"></small>
                 주소:서울 종로구 동천로85번길 8 <br>
               영업시간:18:00 - 01:00<br>
               전화번호:0507-1322-3415<br>
               주차정보:지하주차장 이용불가 가능하며, 1시간 무료 지원됩니다.</h5>
          </div>
        </div>
      </div>
   </div>
    ...
    <div class="text-center">  
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
         ...
         mapOption = { 
             center: new kakao.maps.LatLng(37.5725636, 126.9818234), // 지도의 중심좌표
             level: 3 // 지도의 확대 레벨
         };
         ...
         //마커가 표시될 위치입니다 
         var markerPosition  = new kakao.maps.LatLng(37.5725636, 126.9818234); 
         ...
         var iwContent = '<div style="width:150px;text-align:center;padding:6px 0;">뜻한바', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
         iwPosition = new kakao.maps.LatLng(37.5725646, 126.9818244); //인포윈도우 표시 위치입니다
