...
<div class="logo">
 ...
 <div #swiperRef="" class="swiper mySwiper">
    <div class="swiper-wrapper">
      ...
      <img src="./hansik/joojum1.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./hansik/joojum2.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./hansik/joojum3.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./hansik/joojum4.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./hansik/joojum5.jpg">
      ...
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
          <div class="card-header py-3">
            <h4 class="my-0 fw-normal" align="left">힙한식</h4>
          </div>
          <div class="card-body">
            <h5 class="card-title pricing-card-title" align="left"><small class="text-body-secondary fw-light"></small>
            힙한 한식당이 되고싶은 요리사 부부가 <br>
  남해 식재료들로 정갈한 한식을 만드는 감성한식당 입니다.<br>
  최고의 식재료들로 정성이 들어간 맛을 내려고 노력하고있습니다 <br>
  많은 사랑부탁드립니다 예약은 어플로부탁드리겠습니다.
          </div>
        </div>
      </div>
    </div> 
   ...
   <div class="text-center">  
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
          ...
          <div class="card-body">
            <h5 class="card-title pricing-card-title" align="left"><small class="text-body-secondary fw-light"></small>
               주소 : 서울특별시 종로구 삼청로 113-1  <br>
  영업시간: 16:00 - 03:00 <br>
  전화번호: 02-3234-4578 <br>
  주차정보:  주차장이 없으므로 외부 주차공간을 이용  <br>
               식당근처 5분거리에 공영주차장이 사용이 편리함 <br>
          </div>
        </div>
      </div>
   </div>
    ...
    <div class="text-center">  
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
         ...
         mapOption = { 
             center: new kakao.maps.LatLng(37.5684894, 126.9918234), // 지도의 중심좌표
             level: 3 // 지도의 확대 레벨
         };
         ...
         //마커가 표시될 위치입니다 
         var markerPosition  = new kakao.maps.LatLng(37.5684894, 126.9918234); 
         ...
         var iwContent = '<div style="width:150px;text-align:center;padding:6px 0;">힙한식', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
         iwPosition = new kakao.maps.LatLng(37.5684894, 126.9918234); //인포윈도우 표시 위치입니다
   ...
   <div class="text-center">  
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
          <div class="card-header py-3">
            <h4 class="my-0 fw-normal" align="left">추천리뷰 <h6><a href = "bbs.jsp?boardID=1&pageNumber=1" style="float:right;" >리뷰 전체보기</a></h6></h4>
          </div>
          <div class="card-body">
            <h5 class="card-title pricing-card-title" align="left"><small class="text-body-secondary fw-light"></small>
           ...
           <input type='button' class='btn2' name='btn2' value='리뷰작성' onclick="location.href='write.jsp?boardID=1'" style="float:right; width:200px;">
...
<!--   <div class="container">
    <div class="button-container">
        <button class="button" fixed>예약하기</button>
     </form> -->
