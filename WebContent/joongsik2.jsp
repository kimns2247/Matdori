...
<div class="logo">
 ...
 <div #swiperRef="" class="swiper mySwiper">
    <div class="swiper-wrapper">
     <img src="./joongsik/joong1.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./joongsik/ch1.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./joongsik/mara2.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./joongsik/mara3.jpg"> &nbsp;&nbsp;&nbsp; 
      <img src="./joongsik/mara1.jpg">
      ...
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
          <div class="card-header py-3">
            <h4 class="my-0 fw-normal" align="left">하선생</h4>
          </div>
          <div class="card-body">
            <h5 class="card-title pricing-card-title" align="left"><small class="text-body-secondary fw-light"></small>
                 더 좋은 음식을 위하여 주말 브레이크 타임을 갖기로 하였습니다.   <br>
 너그러운 마음으로 양해부탁드립니다.   <br>
  저희 하선생은 음식의 기본을지켜 , 몸에 이롭고 맛있는 음식을 한그릇 한그릇 정성껏 담아 대접하겠습니다.<br>
          </div>
        </div>
      </div>
    </div> 
   ...
   <div class="text-center">  
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
          ...
          <div class="card-body">
            <h5 class="card-title pricing-card-title" align="left"><small class="text-body-secondary fw-light"></small>
               주소 : 주소 : 서울특별시 종로구 삼일대로20길 15   <br>
영업시간: 13:00 - 08:00  <br>
전화번호: 02-3234-4578  <br>
주차정보:  지상주차장 이용가능하며 ,2시간 무료주차 지원가능  <br>
        </div>
      </div>
   </div>
    ...
    <div class="text-center">  
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
         ...
         var iwContent = '<div style="width:150px;text-align:center;padding:6px 0;">하선생', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
   ...
   <div class="text-center">  
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
          <div class="card-header py-3">
            <h4 class="my-0 fw-normal" align="left">추천리뷰 <h6><a href = "bbs.jsp?boardID=2&pageNumber=1" style="float:right;" >리뷰 전체보기</a></h6></h4>
          </div>
          <div class="card-body">
            <h5 class="card-title pricing-card-title" align="left"><small class="text-body-secondary fw-light"></small>
      ...
      <img src="./joongsik/mara1.jpg">
           ...
           <input type='button' class='btn2' name='btn2' value='리뷰작성' onclick="location.href='write.jsp?boardID=2'" style="float:right; width:200px;">
