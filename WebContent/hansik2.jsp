...
<div class="logo">
 ...
 <div #swiperRef="" class="swiper mySwiper">
    <div class="swiper-wrapper">
      <img src="./hansik/bob1.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./hansik/bob2.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./hansik/bob3.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./hansik/bob4.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./hansik/bob5.jpg">
      ...
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
          <div class="card-header py-3">
            <h4 class="my-0 fw-normal" align="left">온솥</h4>
          </div>
          <div class="card-body">
            <h5 class="card-title pricing-card-title" align="left"><small class="text-body-secondary fw-light"></small>
                 안녕하세요 온솥입니다. <br>
     			저희 온솥은 주문즉시 만든 쌀밥을 베이스로 정성들인 음식을 대접하려고 노력하고 있습니다. <br>
     			맛있는 한끼를 위해 더 노력하겠습니다. 예약은 앱 혹은 전화로 문의주시면 친절하게 답변드리겠습니다
          </div>
        </div>
      </div>
    </div> 
   ...
   <div class="text-center">  
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
          ...
          <div class="card-body">
            <h5 class="card-title pricing-card-title" align="left"><small class="text-body-secondary fw-light"></small>
             주소 : 서울 종로구 동천로 85번길1 <br>
			영업시간: 18:00 - 01:00 <br>
			전화번호: 02-7845-2356 <br>
    ...
    <div class="text-center">  
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
         ...
         mapOption = { 
             center: new kakao.maps.LatLng(37.5710875, 126.9818234), // 지도의 중심좌표
             level: 3 // 지도의 확대 레벨
         };
         ...
         //마커가 표시될 위치입니다 
         var markerPosition  = new kakao.maps.LatLng(37.5710875, 126.9818234); 
         ...
         var iwContent = '<div style="width:150px;text-align:center;padding:6px 0;">온솥', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
         iwPosition = new kakao.maps.LatLng(37.5710875, 126.9818234); //인포윈도우 표시 위치입니다
