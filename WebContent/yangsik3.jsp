...
<div class="logo">
 ...
 <div #swiperRef="" class="swiper mySwiper">
    <div class="swiper-wrapper">
     <img src="./yangsik/hamburger1.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./yangsik/hamburger2.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./yangsik/hamburger3.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./yangsik/hamburger4.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./yangsik/hamburger5.jpg">
      ...
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
          <div class="card-header py-3">
            <h4 class="my-0 fw-normal" align="left">밤가시 버거</h4>
          </div>
          <div class="card-body">
            <h5 class="card-title pricing-card-title" align="left"><small class="text-body-secondary fw-light"></small>
                유기농밀가루로 매일 굽는 빵과 직접 손질해서 만든 100% 소고기패티가 일품인 밤가시버거입니다.   <br>
                오픈한지 얼마 되지 않아 깔끔한 외관과 인테리어가 돋보입니다.  <br>
                한번 맛 보면 다시 찾을 수 밖에 없는 매력이 있는 집입니다.  <br></h5>
          </div>
        </div>
      </div>
    </div> 
   ...
   <div class="text-center">  
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
          ...
          <div class="card-body">
            <h5 class="card-title pricing-card-title" align="left"><small class="text-body-secondary fw-light"></small>
                 주소 : 서울특별시 종로구 북촌로4길 24  <br>
            영업시간: 13:00 - 08:00   <br>
            전화번호:  02-6541-7532  <br>
            주차정보:  상가 주차장 이용가능  <br></h5>
          </div>
        </div>
      </div>
   </div>
    ...
    <div class="text-center">  
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
         ...
         mapOption = { 
             center: new kakao.maps.LatLng(37.5745329, 126.9879906), // 지도의 중심좌표
             level: 3 // 지도의 확대 레벨
         };
         ...
         //마커가 표시될 위치입니다 
         var markerPosition  = new kakao.maps.LatLng(37.5745329, 126.9879906); 
         ...
         var iwContent = '<div style="width:150px;text-align:center;padding:6px 0;">밤가시 버거', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
         iwPosition = new kakao.maps.LatLng(37.5745329, 126.9879906); //인포윈도우 표시 위치입니다
