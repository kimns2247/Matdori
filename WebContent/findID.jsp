...
<style>
    ...
    input[type="text"], input[type="password"] {
         /*   width: 500px; 아이디와 패스워드 입력창의 넓이를 조절합니다. */
...
<main class="form-signin w-100 m-auto text-center" style="display: inline-block; height: 800px;"> 
<div class="text-center">
<a href="index.jsp"><img class="logo" src="./images/matdori_logo.png" alt="" width="100" height="100"></a>
 </div><br><br>
 
 <h4 class="h3 mb-3 fw-normal" id="info1" style="text-align: center;">아이디 찾기 페이지입니다.</h4>
 
  <h5 style="text-align: center;">아이디찾기</h5><br>
 ...
 <button type="submit" id="button" class="button">아이디찾기</button><br><br>
