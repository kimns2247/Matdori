...
<div class="logo">
 ...
 <div #swiperRef="" class="swiper mySwiper">
    <div class="swiper-wrapper">
      <img src="./japan/sushi1.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./japan/sushi2.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./japan/sushi3.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./japan/sushi4.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./japan/sushi5.jpg">
  ...
  <script>
      ...
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
          <div class="card-header py-3">
            <h4 class="my-0 fw-normal" align="left">스시 우미</h4>
          </div>
          <div class="card-body">
            <h5 class="card-title pricing-card-title" align="left"><small class="text-body-secondary fw-light"></small>
               스시오마카세 전문점 스시우미의 3호점 '스시우미 광화문'입니다.<br>
            편안한 분위기에서 합리적인 가격으로 고퀄리티의 서비스를 제공해 드리는 것을 목표로 하고 있습니다.<br>
            24석의 넓은 카운터로 데이트 뿐 아니라 가족 식사, 회식 등 단체 모임에도 적합합니다.<br>
            점심은 초밥 위주의 코스, 저녁은 안줏거리가 다수 추가된 코스로 준비해 드립니다.<br></h5>
          </div>
        </div>
      </div>
    </div> 
   ...
   <div class="text-center">  
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
          ...
          <div class="card-body">
            <h5 class="card-title pricing-card-title" align="left"><small class="text-body-secondary fw-light"></small>
              주소:서울 종로구 삼봉로 81 두산위브파빌리온 B113 <br>
            영업시간:11:30 - 22:00<br>
            전화번호: 0507-1372-0877<br>
            주차정보:지하주차장 이용 가능하며, 2시간 무료 지원됩니다. </h5>
          </div>
        </div>
      </div>
   </div>
    ...
    <div class="text-center">  
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
         ...
         mapOption = { 
             center: new kakao.maps.LatLng(37.571672, 126.98929), // 지도의 중심좌표
             level: 3 // 지도의 확대 레벨
         };
         ...
         //마커가 표시될 위치입니다 
         var markerPosition  = new kakao.maps.LatLng(37.571672, 126.98929); 
         ...
         var iwContent = '<div style="width:150px;text-align:center;padding:6px 0;">스시우미', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
         iwPosition = new kakao.maps.LatLng(37.571672, 126.98929); //인포윈도우 표시 위치입니다
   ...
   <div class="text-center">  
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
          <div class="card-header py-3">
            <h4 class="my-0 fw-normal" align="left">추천리뷰 <h6><a href = "bbs.jsp?boardID=4&pageNumber=1" style="float:right;" >리뷰 전체보기</a></h6></h4>
          </div>
          <div class="card-body">
            <h5 class="card-title pricing-card-title" align="left"><small class="text-body-secondary fw-light"></small>
                 <div #swiperRef="" class="swiper mySwiper2">
             <div class="swiper-wrapper">
               <img src="./japan/japan1.jpg"> &nbsp;&nbsp;&nbsp;
            <img src="./japan/japan2.jpg"> &nbsp;&nbsp;&nbsp;
            <img src="./japan/japan3.jpg"> &nbsp;&nbsp;&nbsp;
            <img src="./japan/japan4.jpg"> &nbsp;&nbsp;&nbsp;
            <img src="./japan/japan5.jpg">
            <div class="swiper-slide">slide 1</div>
            <div class="swiper-slide">Slide 2</div>
            <div class="swiper-slide">Slide 3</div>
             </div>
           ...
           <input type='button' class='btn2' name='btn2' value='리뷰작성' onclick="location.href='write.jsp?boardID=4'" style="float:right; width:200px;">
