...
<div class="logo">
 ...
 <div #swiperRef="" class="swiper mySwiper">
    <div class="swiper-wrapper">
      <img src="./yangsik/yangsik1.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./yangsik/yangsik2.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./yangsik/yangsik3.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./yangsik/yangsik4.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./yangsik/yangsik5.jpg">
      ...
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
          <div class="card-header py-3">
            <h4 class="my-0 fw-normal" align="left">스테이크 하우스</h4>
          </div>
          <div class="card-body">
            <h5 class="card-title pricing-card-title" align="left"><small class="text-body-secondary fw-light"></small>
                세계적으로 유명한 뉴욕 정통 드라이에이징 기술을 이용해 <br>
                한국에서 뉴욕스테이크의 맛 1위를 당당히 차지하고있는 맛집입니다. <br>
                많은 사랑부탁드립니다.
          </div>
        </div>
      </div>
   ...
   <div class="text-center">  
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
          ...
          <div class="card-body">
            <h5 class="card-title pricing-card-title" align="left"><small class="text-body-secondary fw-light"></small>
               주소 : 서울특별시 종로구 창덕궁1길 32  <br>
            영업시간: 18:00 - 01:00  <br>
            전화번호: 02-6656-9898  <br>
    ...
    <div class="text-center">  
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
         ...
         var iwContent = '<div style="width:150px;text-align:center;padding:6px 0;">스테이크 하우스', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
