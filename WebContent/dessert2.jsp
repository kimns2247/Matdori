...
<div class="logo">
 ...
 <div #swiperRef="" class="swiper mySwiper">
    <div class="swiper-wrapper">
     ...
     <img src="./dessert/bagel0.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./dessert/bagel1.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./dessert/bagel2.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./dessert/bagel3.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./dessert/bagel4.jpg">
      ...
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
          <div class="card-header py-3">
            <h4 class="my-0 fw-normal" align="left">런던 베이글</h4>
          </div>
          <div class="card-body">
            <h5 class="card-title pricing-card-title" align="left"><small class="text-body-secondary fw-light"></small>
              다정한 스텝과 방금 나온 베이글.<br>
 그리고 따뜻한 수프가 기다리는<br>
 가장 가까운 런던 속 베이글 뮤지엄,<br>

 국내 어디에서도 맛볼 수 없었던<br>
 베이글의 식감과 무드를 선보입니다.<br>
          </div>
        </div>
      </div>
    </div> 
    ...
    <div class="text-center">  
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
         ...
         mapOption = { 
             center: new kakao.maps.LatLng(37.5723533, 126.9879906), // 지도의 중심좌표
             level: 3 // 지도의 확대 레벨
         };
         ...
         //마커가 표시될 위치입니다 
         var markerPosition  = new kakao.maps.LatLng(37.5723533, 126.9879906); 
         ...
         var iwContent = '<div style="width:150px;text-align:center;padding:6px 0;">런던베이글', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
         iwPosition = new kakao.maps.LatLng(37.5723533, 126.9879906); //인포윈도우 표시 위치입니다
