...
<div class="logo">
 ...
 <div #swiperRef="" class="swiper mySwiper">
    <div class="swiper-wrapper">
      <img src="./japan/iza1.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./japan/iza2.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./japan/iza3.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./japan/iza4.jpg"> &nbsp;&nbsp;&nbsp;
      <img src="./japan/iza5.jpg">
      ...
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
          ...
          <div class="card-body">
            ...
            주차정보:지하주차장 이용 가능하며, 2시간 무료 지원됩니다. <br></h5>
          </div>
        </div>
      </div>
   </div>
    ...
    <div class="text-center">  
      <div>
        <div class="card mb-4 rounded-3 shadow-sm" style="width: 100%;">
         ...
         mapOption = { 
             center: new kakao.maps.LatLng(37.5723379, 126.9879906), // 지도의 중심좌표
             level: 3 // 지도의 확대 레벨
         };
         ...
         //마커가 표시될 위치입니다 
         var markerPosition  = new kakao.maps.LatLng(37.5723379, 126.9879906); 
         ...
         var iwContent = '<div style="width:150px;text-align:center;padding:6px 0;">로바타아키', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
         iwPosition = new kakao.maps.LatLng(37.5723379, 126.9879906); //인포윈도우 표시 위치입니다
