...
# 프로젝트 소개
- 예약, 결제, 위치정보 등의 기능을 제공하여 바쁜 일상 속에서 식사에 소요되는 시간을 줄이고자 하는 니즈에 부응하여 다양한 음식 선택이 가능합니다. 사용자들 간의 리뷰, 평가, 추천을 통해 음식과 음식점에 대한 정보를 교류할 수 있는 커뮤니케이션의 역할도 합니다. 이러한 측면들을 통해 음식점과 소비자들 간의 상호 작용을 촉진하고자 하는 목적을 가지고 개발하였습니다.
